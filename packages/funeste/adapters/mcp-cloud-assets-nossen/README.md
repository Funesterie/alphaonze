...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-cloud-assets@0.1.1`.
...
```bash
npm install @funeste/mcp-cloud-assets-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-cloud-assets-nossen");
