...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-web-drafts@0.1.1`.
...
```bash
npm install @funeste/mcp-web-drafts-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-web-drafts-nossen");
