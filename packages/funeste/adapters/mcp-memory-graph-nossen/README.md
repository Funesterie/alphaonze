...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-memory-graph@0.1.1`.
...
```bash
npm install @funeste/mcp-memory-graph-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-memory-graph-nossen");
