...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-media-bridge@0.1.1`.
...
```bash
npm install @funeste/mcp-media-bridge-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-media-bridge-nossen");
