...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-retro-session@0.1.1`.
...
```bash
npm install @funeste/mcp-retro-session-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-retro-session-nossen");
