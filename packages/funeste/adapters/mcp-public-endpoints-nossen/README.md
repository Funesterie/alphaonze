...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-public-endpoints@0.1.1`.
...
```bash
npm install @funeste/mcp-public-endpoints-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-public-endpoints-nossen");
