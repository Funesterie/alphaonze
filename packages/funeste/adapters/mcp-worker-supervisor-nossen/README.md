...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-worker-supervisor@0.1.1`.
...
```bash
npm install @funeste/mcp-worker-supervisor-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-worker-supervisor-nossen");
