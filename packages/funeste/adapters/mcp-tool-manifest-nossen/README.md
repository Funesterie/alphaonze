...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-tool-manifest@0.1.1`.
...
```bash
npm install @funeste/mcp-tool-manifest-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-tool-manifest-nossen");
