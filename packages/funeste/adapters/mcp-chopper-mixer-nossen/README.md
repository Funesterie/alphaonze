...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-chopper-mixer@0.1.1`.
...
```bash
npm install @funeste/mcp-chopper-mixer-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-chopper-mixer-nossen");
