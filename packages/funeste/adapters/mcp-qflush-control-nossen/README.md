...
Private Funeste/NOSSEN wrapper for `@nossen/mcp-qflush-control@0.1.1`.
...
```bash
npm install @funeste/mcp-qflush-control-nossen
```

## Usage

```js
const mcp = require("@funeste/mcp-qflush-control-nossen");
