...
3. `a11/runtime/knowledge-graph/a11-route-map.json`
4. `a11/backend/apps/server/scripts/sync-codex-vs-neo4j.cjs`

Puis appelle via MCP, si disponible:

1. `a11_health`
2. `a11_mcp_dimension_status`
3. `a11_route_map`
4. `neo4j_status` sur `a11mcp-shared`
