  ...
  return (
    <div className="space-y-10 py-12">
      <header>
        ...
        <h1 className="font-display text-4xl font-bold">✍️ Réflexions abouties</h1>
        <p className="text-[var(--ink-soft)] mt-4 max-w-2xl">
          Articles finis, histoires à partager, analyses structurées. Ce qui est prêt à être lu,
          commenté, discuté.
        </p>
      </header>
      ...
      {posts.length > 0 ? (
        ...
        <div className="text-center py-12">
          <p className="text-[var(--ink-soft)]">Le Blog est vide.</p>
          <p className="text-sm text-[var(--ink-soft)] mt-2">
            Ajoute des articles en Markdown dans <code className="bg-[var(--ground)] px-2 py-1 rounded">content/blog/</code>
          </p>
        </div>
      )}
    </div>
