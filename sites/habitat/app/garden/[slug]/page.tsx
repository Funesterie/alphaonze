...
export default function GardenPostPage({ params }: { params: { slug: string } }) {
  const post = getPost('garden', params.slug);
    ...
    <div className="space-y-8 py-12">
      ...
      <div className="border-t border-[var(--rule)] pt-8">
        <p className="text-[var(--ink-soft)] text-sm">
          Cette note fait partie du Garden. Elle peut évoluer, être modifiée ou supprimée.
        </p>
      </div>
    </div>
  );
