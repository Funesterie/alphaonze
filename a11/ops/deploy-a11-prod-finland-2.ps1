...
services:
  ...
  a11-backend:
    ...
    environment:
      ...
      VIVY_NOSSEN_CLOUD_ATTEMPT_TIMEOUT_MS: ${VIVY_NOSSEN_CLOUD_ATTEMPT_TIMEOUT_MS:-8000}
      ...
      ACESTEP_DEFAULT_DURATION_SECONDS: ${ACESTEP_DEFAULT_DURATION_SECONDS:-120}
...
$overrides = [ordered]@{
  ...
  VIVY_NOSSEN_CLOUD_ATTEMPT_TIMEOUT_MS = "8000"
  ...
  ACESTEP_DEFAULT_DURATION_SECONDS = "120"
...
printf 'VIVY_NOSSEN_CLOUD_ATTEMPT_TIMEOUT_MS=8000\n' >> "$tmp_build"
...
printf 'ACESTEP_DEFAULT_DURATION_SECONDS=120\n' >> "$tmp_build"
