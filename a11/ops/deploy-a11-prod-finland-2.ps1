...
$overrides = [ordered]@{
  ...
  STRIPE_PRICE_ID = "price_1Tdp54HkqLcMgv54haf1faZV"
  STRIPE_PREMIUM_PRICE_ID = "price_1Tdp54HkqLcMgv54haf1faZV"
  STRIPE_FOUNDER_PRICE_ID = "price_1Tdp55HkqLcMgv54eIhku9Ah"
  ...
  A11_HF_VIDEO_PROVIDER = "fal-ai"
  A11_HF_VIDEO_MODEL = "Wan-AI/Wan2.2-TI2V-5B"
  A11_HF_VIDEO_FRAMES = "16"
