...
$overrides = [ordered]@{
  ...
  A11_ELEVENLABS_KAEN44_VOICE_ID = $(if ($env:A11_ELEVENLABS_KAEN44_VOICE_ID) { $env:A11_ELEVENLABS_KAEN44_VOICE_ID } elseif (-not [string]::IsNullOrWhiteSpace([string]$envMap["A11_ELEVENLABS_KAEN44_VOICE_ID"])) { [string]$envMap["A11_ELEVENLABS_KAEN44_VOICE_ID"] } else { "EXAVITQu4vr4xnSDxMaL" })
  A11_ELEVENLABS_K44_VOICE_ID = $(if ($env:A11_ELEVENLABS_K44_VOICE_ID) { $env:A11_ELEVENLABS_K44_VOICE_ID } elseif ($env:A11_ELEVENLABS_KAEN44_VOICE_ID) { $env:A11_ELEVENLABS_KAEN44_VOICE_ID } elseif (-not [string]::IsNullOrWhiteSpace([string]$envMap["A11_ELEVENLABS_K44_VOICE_ID"])) { [string]$envMap["A11_ELEVENLABS_K44_VOICE_ID"] } elseif (-not [string]::IsNullOrWhiteSpace([string]$envMap["A11_ELEVENLABS_KAEN44_VOICE_ID"])) { [string]$envMap["A11_ELEVENLABS_KAEN44_VOICE_ID"] } else { "EXAVITQu4vr4xnSDxMaL" })
