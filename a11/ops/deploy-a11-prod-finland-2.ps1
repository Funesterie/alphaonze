...
$overrides = [ordered]@{
  ...
  VIVY_SONG_GROQ_MODEL = $(if ($env:VIVY_SONG_GROQ_MODEL) { $env:VIVY_SONG_GROQ_MODEL } elseif ($envMap.Contains("VIVY_SONG_GROQ_MODEL") -and -not [string]::IsNullOrWhiteSpace([string]$envMap["VIVY_SONG_GROQ_MODEL"])) { [string]$envMap["VIVY_SONG_GROQ_MODEL"] } else { "openai/gpt-oss-120b" })
  ...
  A11_TRANSLATION_MODEL = "openai/gpt-oss-20b"
  ...
  SOCIAL_OAUTH_COOKIE_DOMAIN = $(if ($env:SOCIAL_OAUTH_COOKIE_DOMAIN) { $env:SOCIAL_OAUTH_COOKIE_DOMAIN } elseif ($envMap.Contains("SOCIAL_OAUTH_COOKIE_DOMAIN")) { [string]$envMap["SOCIAL_OAUTH_COOKIE_DOMAIN"] } else { ".funesterie.me" })
  ...
  VIVY_SUNO_MODEL = $(if ($env:VIVY_SUNO_MODEL) { $env:VIVY_SUNO_MODEL } else { "V6" })
  VIVY_SUNO_LONG_MODEL = $(if ($env:VIVY_SUNO_LONG_MODEL) { $env:VIVY_SUNO_LONG_MODEL } else { "V6" })
...
printf 'VIVY_SUNO_MODEL=V6\n' >> "$tmp_build"
printf 'VIVY_SUNO_LONG_MODEL=V6\n' >> "$tmp_build"
