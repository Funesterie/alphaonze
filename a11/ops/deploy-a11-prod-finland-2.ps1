...
$StrongSongOllamaModel = if ($env:A11_OLLAMA_STRONG_SONG_MODEL) { $env:A11_OLLAMA_STRONG_SONG_MODEL } else { "qwen2.5:7b" }
...
tmp_build="$(mktemp)"
managed_keys='^(A11_BUILD_COMMIT|A11_BUILD_BRANCH|A11_BUILD_DATE|A11_VOICE_XTTS_RVC_FALLBACK|A11_LLM_PROVIDER|A11_OLLAMA_PRIMARY_MODEL|A11_OLLAMA_FALLBACK_MODEL|A11_OLLAMA_STRONG_SONG_MODEL|VIVY_CHAT_LOCAL_FIRST|VIVY_OLLAMA_BASE_URL|VIVY_CHAT_LOCAL_MODEL|VIVY_XAI_MODEL|OLLAMA_CLOUD_ENABLED|OLLAMA_CLOUD_BASE_URL|OLLAMA_CLOUD_LYRICS_MODEL|OLLAMA_CLOUD_FAST_MODEL|OLLAMA_CLOUD_THINK_LEVEL|OLLAMA_CLOUD_LYRICS_TIMEOUT_MS|VIVY_SONG_CERBERE_FALLBACK_ENABLED|VIVY_SONG_CERBERE_MODEL|VIVY_SONG_CERBERE_TIMEOUT_MS|VIVY_GROQ_RATE_LIMIT_COOLDOWN_MS|VIVY_CHAT_MAX_TOKENS_SONG|VIVY_CHAT_MAX_TOKENS_SONG_CEILING|VIVY_SONG_ALLOW_LOCAL_FALLBACK|VIVY_SONG_LOCAL_MODEL|A11_TRANSLATION_MODEL|LOCAL_DEFAULT_MODEL|A11_LLM_FALLBACK_PROVIDER|A11_LLM_RUNTIME_FALLBACK_ORDER|A11_CERBERE_LOCAL_ONLY|A11_LOCAL_CHAT_TIMEOUT_MS|A11_LOCAL_SONG_TIMEOUT_MS|A11_OLLAMA_KEEP_ALIVE|A11_MEMORY_LOCAL_TIMEOUT_MS|A11_MEMORY_REMOTE_TIMEOUT_MS|A11_EMBEDDING_TIMEOUT_MS|A11_RUNTIME_ROOT|VIVY_ELEVENLABS_MUSIC_DISABLED|VIVY_MUSIC_PROVIDER|VIVY_MUREKA_API_KEY_FILE|VIVY_MUREKA_BASE_URL|VIVY_MUREKA_MODEL|VIVY_SUNO_MODEL|VIVY_STREAM_AUTOGENERATE_ENABLED|VIVY_STREAM_IDLE_JUKEBOX_DISABLED|VIVY_STREAM_STATE_URL|VIVY_PUBLIC_BASE_URL|VIVY_STREAM_BOT_MESSAGE_GAP_MS|VIVY_STREAM_COVER_ENABLED|VIVY_STREAM_COVER_URL|VIVY_STREAM_COVER_TIMEOUT_MS|VIVY_STREAM_CLIP_ENABLED|VIVY_STREAM_CLIP_PROVIDER|VIVY_STREAM_CLIP_DURATION_SECONDS|VIVY_STREAM_CLIP_TIMEOUT_MS|VIVY_STREAM_FULL_CLIP_ENABLED|VIVY_STREAM_FULL_CLIP_SCENES|VIVY_STREAM_FULL_CLIP_INSTRUMENTAL_SCENES|VIVY_STREAM_FULL_CLIP_UNIQUE_LOOPS|VIVY_STREAM_FULL_CLIP_REUSE_CHORUS|VIVY_STREAM_FULL_CLIP_CONCURRENCY|VIVY_STREAM_FULL_CLIP_GENERATE_SCENE_LOOPS|VIVY_STREAM_FULL_CLIP_LOOP_SECONDS|VIVY_STREAM_FULL_CLIP_WIDTH|VIVY_STREAM_FULL_CLIP_HEIGHT|VIVY_STREAM_FULL_CLIP_FPS|VIVY_STREAM_FULL_CLIP_CROP_SOURCE_IMAGE|VIVY_STREAM_FULL_CLIP_SOURCE_CROP_WIDTH_RATIO|VIVY_STREAM_FULL_CLIP_SOURCE_CROP_X_BIAS|VIVY_STREAM_FULL_CLIP_SOURCE_CROP_Y_BIAS|VIVY_STREAM_FULL_CLIP_DEMOSAIC_GRID|VIVY_STREAM_FULL_CLIP_DEMOSAIC_COLUMNS|VIVY_STREAM_FULL_CLIP_DEMOSAIC_ROWS|VIVY_STREAM_FULL_CLIP_DEMOSAIC_ACTIVE_HEIGHT_RATIO|VIVY_STREAM_FULL_CLIP_DEMOSAIC_SEGMENT_SECONDS|VIVY_STREAM_FULL_CLIP_DEMOSAIC_ORDER|A11_VIDEO_PROXY_URL|A11_VIDEO_PROXY_TOKEN|A11_VIDEO_PROXY_PUBLIC_FILE_BASE_URL|A11_VIDEO_PROXY_TIMEOUT_MS|A11_VIDEO_ASYNC_JOB_TTL_MS|A11_VIDEO_COMFY_CLOUD_ENABLED|A11_COMFY_CLOUD_API_KEY|A11_COMFY_CLOUD_BASE_URL|A11_COMFY_CLOUD_WORKFLOW_PATH|A11_COMFY_CLOUD_TIMEOUT_MS|A11_COMFY_CLOUD_POLL_INTERVAL_MS|A11_COMFY_CLOUD_WAN_MODEL|A11_COMFY_CLOUD_WAN_RESOLUTION)='
