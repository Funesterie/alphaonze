...
$overrides = [ordered]@{
  ...
  A11_CARTESIA_TTS_DISABLED = "true"
  CARTESIA_TTS_DISABLED = "true"
  A11_ELEVENLABS_TTS_DISABLED = "true"
  ELEVENLABS_TTS_DISABLED = "true"
  VIVY_ELEVENLABS_MUSIC_DISABLED = "true"
  A11_ELEVENLABS_API_KEY_FILE = $(if ($env:A11_ELEVENLABS_API_KEY_FILE) { $env:A11_ELEVENLABS_API_KEY_FILE } else { "" })
  VIVY_ELEVENLABS_API_KEY_FILE = $(if ($env:VIVY_ELEVENLABS_API_KEY_FILE) { $env:VIVY_ELEVENLABS_API_KEY_FILE } else { "" })
  A11_ELEVENLABS_A11_VOICE_ID = $(if ($env:A11_ELEVENLABS_A11_VOICE_ID) { $env:A11_ELEVENLABS_A11_VOICE_ID } else { "" })
