...
services:
  ...
  a11-backend:
    ...
    environment:
      ...
      VIVY_STREAM_DREAMCLIP_SCENES: ${VIVY_STREAM_DREAMCLIP_SCENES:-}
      ...
      A11_REPLICATE_VIDEO_MODEL: ${A11_REPLICATE_VIDEO_MODEL:-wan-video/wan-2.2-i2v-fast}
...
[ -n "$a11_replicate_video_model" ] || a11_replicate_video_model="wan-video/wan-2.2-i2v-fast"
