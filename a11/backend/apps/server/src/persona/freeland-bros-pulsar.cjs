...
const PULSAR_COLORS = [
  { name: 'PurpleShadow', hex: '0x4a0a8a', hue: 265, function: 'sel relationnel',         complement: 'Orange',       gamma: 0.15 },
  { name: 'DeepBlue',      hex: '0x0a4a8a', hue: 200, function: 'chiffrement RSA',        complement: 'Bleu-Gris',    gamma: 0.30 },
  { name: 'BloodRed',      hex: '0x8a0a0a', hue: 0,   function: 'compression HEVC',       complement: 'Flamme-Bleu',  gamma: 0.75 },
  { name: 'ToxicGreen',    hex: '0x0a8a4a', hue: 120, function: 'energie NVENC',          complement: 'Magenta',      gamma: 0.95 },
  ...
  { name: 'DORE',         hex: '0x8a8a0a', hue: 60,  function: 'blindage alchimique',   complement: 'Noir-Petrole', gamma: 0.88 },
  { name: 'Violet',       hex: '0x4a0a4a', hue: 280, function: 'signal',                 complement: 'FireOrange',   gamma: 0.40 },
