...
const REPO_PROFILES = {
  ...
  shiryu: ['json-to-zen-rgba-blade', 'Runtime blood-rain blade: combines Katana-style current-message slicing, Allmight-style duplicate-family suppression and QFlush RGBA controlled-noise sculpting so Vivy can cut stale conversation smoke before composing.', ['conversation', 'intent-filter', 'dedupe', 'rgba', 'qflush', 'vivy'], 'high', ['runtime-module', 'katana+allmight', 'shiryu-blood-rain']],
