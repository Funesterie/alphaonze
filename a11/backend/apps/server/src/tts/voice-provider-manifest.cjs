...
const MANIFEST = Object.freeze({
  a11: {
    ...
    providers: {
      ...
      [PROVIDERS.XTTS_RVC]:   { configured: 'runtime', modelPath: 'voice-library/A11 ref.wav', note: 'A11 ref: source of truth for A11 voice, converted from A11 ref.mp3 at 22050Hz mono PCM16.' },
  ...
  kaen44: {
    ...
    providers: {
      ...
      [PROVIDERS.XTTS_RVC]:   { configured: 'runtime', modelPath: 'voice-library/K44 Ref.wav', note: 'K44 Ref: source of truth for K44 voice, converted from K44 Ref.m4a at 22050Hz mono PCM16.' },
      [PROVIDERS.PIPER]:      { configured: true,  note: 'Neutral fallback when cloud voices are not configured.' },
    },
  },
  vivy: {
    ...
    providers: {
      ...
      [PROVIDERS.XTTS_RVC]:   { configured: 'runtime', modelPath: 'voice-library/Vivy ref.wav', note: 'Vivy ref: source of truth for Vivy voice, converted from Vivy ref.wav at 22050Hz mono PCM16.' },
      [PROVIDERS.PIPER]:      { configured: true,  note: 'Neutral fallback when cloud voices are not configured.' },
    },
  },
  'demo-alice': {
