...
const FAMILY_VOICE_IDENTITIES = Object.freeze({
  ...
  k44: Object.freeze({
    ...
    referencePath: 'voice-library/K44 Ref.wav',
    referenceStatus: 'ready-local-reference',
  ...
  a11: Object.freeze({
    ...
    referencePath: 'voice-library/A11 ref.wav',
    referenceStatus: 'ready-local-reference',
    note: 'Voix officielle A11 rattachee a Gerard; reference locale lisible active.',
  }),
  vivy: Object.freeze({
    key: 'vivy',
    ...
    referencePath: 'voice-library/Vivy ref.wav',
    referenceStatus: 'ready-local-reference',
    note: 'Voix officielle Vivy rattachee a Charlene; reference locale lisible active.',
  }),
});
