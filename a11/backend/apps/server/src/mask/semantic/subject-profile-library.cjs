...
const RAW_SUBJECT_PROFILES = [
  ...
  {
    type: 'reference_character',
    label: 'Personnage de référence James Bond',
    aliases: ['james bond', 'james-bond', 'agent 007', 'agent secret 007'],
    definitionKeywords: ['james bond', 'agent 007', 'espion britannique', 'fiction d espionnage'],
    canonicalSubject: 'James Bond',
    composition: ['un seul personnage complet', 'visage unique bien lisible', 'pose claire et lisible', 'silhouette reconnaissable'],
    environment: ['fond simple cohérent avec le personnage'],
    styleHints: ['illustration espionnage nette', 'costume sombre lisible', 'illustration nette'],
    promptInstruction: 'Représenter clairement James Bond, un seul espion britannique complet et reconnaissable, en costume sombre élégant.',
  },
  {
    type: 'reference_character',
    label: 'Personnage de référence Goku',
    aliases: ['goku', 'son goku'],
    definitionKeywords: ['goku', 'dragon ball', 'saiyan', 'combattant anime'],
    canonicalSubject: 'Goku',
    composition: ['un seul personnage complet', 'visage unique bien lisible', 'pose claire et lisible', 'silhouette reconnaissable'],
    environment: ['fond simple cohérent avec le personnage'],
    styleHints: ['illustration anime de combat nette', 'tenue orange et bleue lisible'],
    promptInstruction: 'Représenter clairement Goku, un seul combattant anime complet et reconnaissable, avec une tenue d arts martiaux orange et bleue bien lisible.',
  },
  {
    type: 'reference_character',
    label: 'Personnage de référence Vegeta',
    aliases: ['vegeta'],
    definitionKeywords: ['vegeta', 'dragon ball', 'saiyan', 'combattant anime'],
    canonicalSubject: 'Vegeta',
    composition: ['un seul personnage complet', 'visage unique bien lisible', 'pose claire et lisible', 'silhouette reconnaissable'],
    environment: ['fond simple cohérent avec le personnage'],
    styleHints: ['illustration anime de combat nette', 'armure bleue et blanche lisible'],
    promptInstruction: 'Représenter clairement Vegeta, un seul combattant anime complet et reconnaissable, avec une armure de combat bleue et blanche bien lisible.',
  },
  {
    type: 'reference_character',
    label: 'Personnage de référence Dragon Ball',
    aliases: ['gohan', 'goten', 'gogeta', 'broly'],
    definitionKeywords: ['dragon ball', 'saiyan', 'combattant anime'],
    composition: ['un seul personnage complet', 'visage unique bien lisible', 'pose claire et lisible', 'silhouette reconnaissable'],
    environment: ['fond simple cohérent avec le personnage'],
    styleHints: ['illustration anime de combat nette', 'tenue de combat anime lisible'],
    promptInstruction: 'Représenter clairement un seul combattant anime de Dragon Ball, complet, reconnaissable et bien lisible.',
  },
  {
    type: 'reference_character',
    label: 'Personnage de référence',
    aliases: [
      'naruto', 'boruto', 'sasuke', 'pikachu',
      'batman', 'robin', 'donkey kong', 'one piece',
      'luffy', 'monkey d luffy', 'sanji', 'vinsmoke sanji', 'zoro', 'roronoa zoro',
      'nami', 'usopp', 'brook', 'nico robin', 'robin one piece', 'franky', 'chopper', 'tony tony chopper',
    ],
