...
const MONDE = {
  ...
  domaines: {
    ...
    lectureProposee: [
      ...
      'LE ROTOR D A11 ALIMENTE L ETINCELLE DE REI. L androide de la mine fournit le courant au Foudroyant : celui qu on gardait pour extraire est devenu la source de celui qui allume.',
