...
const MONDE = {
  ...
  domaines: {
    ...
    lectureProposee: [
      ...
      'LES DIX ARTEFACTS SONT UN MOTEUR DEMONTE ET REPARTI. Rei l allumage (bobine CDI, etincelle), Kaen44 la combustion et l echappement (chaleur, fonte), Vivy l admission (souffle, resonance). Ce ne sont pas des trophees : c est une mecanique distribuee entre des gens, et c est pour ca qu ils ne valent qu ensemble.',
