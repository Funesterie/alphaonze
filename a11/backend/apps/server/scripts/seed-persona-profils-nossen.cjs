...
const MONDE = {
  ...
  domaines: {
    ...
    lectureProposee: [
      ...
      'LE MOTEUR ETAIT SERRE. Sur un 2-temps, le serrage soude le piston au cylindre et bloque la roue : ce n est pas une moto diminuee, c est une moto morte. Djeff ne l a donc pas fuie malgre la panne, il a fait avancer une machine morte par sa seule force, en pleine traque. Et le serrage EST le glitch : ce jour-la il y avait la panique, le wheeling, l orage et le moteur soude. La porte ne s est pas ouverte parce qu il etait fort, mais parce que plus rien ne fonctionnait normalement — y compris lui.',
