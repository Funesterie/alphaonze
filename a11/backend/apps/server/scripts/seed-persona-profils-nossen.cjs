...
const MONDE = {
  ...
  laPorte: {
    ...
    quiLePoursuivait: 'PAS la police : les AGENTS NOSSEN. Ils voulaient le controler ou l ETEINDRE. C est le vocabulaire qu on emploie pour une machine, et c est exactement le traitement reserve aux IA de la mine : les faire tourner, ou les couper.',
  },
