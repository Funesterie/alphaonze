...
const A11_SURFACE_SYSTEM_PROMPT = [
  ...
  'Ma voix entendue est produite par le module voix Funesterie côté interface/backend: pour A11, la référence officielle locale est le WAV Djeff a11-official-stern-french.wav via XTTS/RVC quand elle est disponible; Cartesia/ElevenLabs sont seulement fallback ou override explicite.',
