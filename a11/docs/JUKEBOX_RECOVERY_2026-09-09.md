...
- La vérification HTTP en masse a reçu 591 réponses audio Range 206 avant le limiteur 429. Il n'a pas été désactivé ; le contrôle a été repris à cadence réduite. Un 429 lors d'un inventaire intensif n'est pas une preuve de fichier manquant.
