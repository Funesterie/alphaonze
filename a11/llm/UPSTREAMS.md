...
- dossier local canonique: `D:\funesterie\a11\llm\llama.cpp`
- dossier legacy local encore tolere: `D:\funesterie\a11\a11llm\llama.cpp`
...
Ce repo `llm` ne versionne pas ce clone.
