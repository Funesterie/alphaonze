...
Date: 2026-03-26
Workspace: `D:\funesterie\a11\dragon`
Scope reviewed: `D:\`
...
| `D:\funesterie\a11\backend` | Deployment wrapper | Keep only for deploy recipes |
| `D:\funesterie\a11\frontend` | Deployment wrapper | Keep only for deploy recipes |
...
Start with a modular umbrella repo in `D:\funesterie\a11\dragon`.
...
1. Create a Dragon workspace in `D:\funesterie\a11\dragon`.
